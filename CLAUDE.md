...
This is a learning repository for the **10xDevs** course. At present it contains no application code — only configuration tracking the `@przeprogramowani/10x-cli` tool that pulls down course lesson artifacts (skills, prompts, rules).

- `skills-lock.json` — manifest of installed 10x-cli skills with source repo and content hashes. Treat this as managed by `10x-cli`; do not hand-edit.
